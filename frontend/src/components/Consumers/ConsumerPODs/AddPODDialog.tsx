...
export const AddPODDialog = ({ consumerId }: AddPODDialogProps) => {
  ...
  const onSubmit = async (data: PODFormValues) => {
    try {
      ...
      toast({
        title: "Success",
        description: "POD has been added successfully",
      });
      ...
      <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
        ...
        <Form {...form}>
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
            ...
            <Button type="submit" className="w-full">Add POD</Button>
          </form>
        </Form>
      </DialogContent>
    </Dialog>
